...
public class twofish {
	...
	public twofish(KeyGen key, String plaintext) {
		...
		this.plainText = StaticMethods.hexStringToByteArray(StaticMethods.StringToHex(plaintext));
		System.out.println("-------------------------------------------------------------------");
	}
	
	public String encrypt() {
		System.out.println("Original: ");
		StaticMethods.printByteArray(this.plainText);
		byte res[] = Whitening(key.getWhiteningSubkey(true));
		System.out.println("\nInput Whitening:");
		...
		res = Whitening(key.getWhiteningSubkey(false));
		System.out.println("\nOutput Whitening:");
		StaticMethods.printByteArray(res);
	...
	private byte[] Whitening(byte[] subkey) {
		//XOR plaintText with subkey
		return StaticMethods.xorByteArrays(plainText, subkey);
	}
